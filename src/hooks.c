...
/*   Updated: 2023/07/10 19:30:43 by beeligul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    int mouse_x = WIDTH / 2 - x;
    int mouse_y = HEIGHT / 2 - y;
    ...
    my_fractal->move_x += 0.5 * my_fractal->zoom_rate * (double)mouse_x / (double)(WIDTH / 2);
    my_fractal->move_y += 0.5 * my_fractal->zoom_rate * (double)mouse_y / (double)(HEIGHT / 2);
